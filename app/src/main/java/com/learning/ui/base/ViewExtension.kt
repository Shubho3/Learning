...
import com.learning.ui.customview.CircleImageView
import java.io.File
...
fun <T> getPlaceHolder(
    ...
    if (imageLoadersArray[0] == imageLoaderType) {
        drawableTypeRequest.error(R.drawable.ic_launcher_foreground)
        drawableTypeRequest.placeholder(R.drawable.ic_launcher_foreground)
        ...
        drawableTypeRequest.error(R.color.purple_200)
        drawableTypeRequest.placeholder(R.color.purple_200)
    }
